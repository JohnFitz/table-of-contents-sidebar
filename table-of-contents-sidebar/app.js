function showToc() {
    chrome.storage.sync.get({
        ...
        TableOfContents.activePin(); //The state of the default pin
    });
}
var sidebar_id = "table-of-contents-sidebar-id";

function hideToc() {
    document.getElementById(sidebar_id).outerHTML = '';
    document.getElementById("table-of-contents-sidebar-hover-menu-id").outerHTML = '';
}

function isAlreadyToc() {
    var ele = document.getElementById(sidebar_id);
    return !!ele;
}
